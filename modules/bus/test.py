...
def get_by_class(classs='def', route='def', bus_stop='def'):
    global req_name_list  # Declare req_name_list as a global variable
    temp_name_list = []
...
# Add a function to retrieve req_name_list
@eel.expose
def get_req_name_list():
    return req_name_list

# Example usage with all criteria specified

#get_by_class("xii", 'def', 'def')


eel.start("bus.html", size=(550, 500))
